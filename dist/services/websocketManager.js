...
class ScoreboardWebSocketManager {
    constructor() {
        ...
        this.pythonWebSocketMap = new Map();
    }
    /**
     ...
     */
    connectToPythonBackend(clientWs) {
        try {
            ...
            const pythonWs = new ws_1.default(pythonWsUrl);
...
class PlaybyplayWebSocketManager {
     ...
     */
    handleConnection(gameId, clientWs) {
     ...
     */
    connectToPythonBackend(gameId, clientWs) {
        try {
