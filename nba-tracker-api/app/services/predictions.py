                    ...
                    if bracket_start > 0:
                        ...
                        try:
                            ...
                            if isinstance(parsed_data, dict) and "insights" in parsed_data:
                                logger.info(
                                    f"Recovered {len(parsed_data['insights'])} game insights from truncated JSON"
                                )
    ...
    try:
        ...
        for idx, game in enumerate(games, 1):
            try:
                ...
                home_win_prob = calculate_win_probability(home_win_pct, away_win_pct, home_net_rating, away_net_rating)
